...
return new class extends Migration
{
    ...
    {
        Schema::create('popular_family_cars', function (Blueprint $table) {
            $table->id();
            $table->string('title');
            $table->string('price');
            $table->string('monthly')->nullable(); // From your static data
            $table->integer('year')->nullable();   // From your static data
    ...
    {
        Schema::dropIfExists('popular_family_cars');
    }
};