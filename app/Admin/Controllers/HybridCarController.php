...
class HybridCarController extends AdminController
{
    protected $title = 'HybridCar';

    protected function grid()
    {
        $grid = new Grid(new HybridCar());
    ...
    {
        $show = new Show(HybridCar::findOrFail($id));
