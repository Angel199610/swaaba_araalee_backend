...
class LuxuryCarController extends AdminController
{
    protected $title = 'LuxuryCar';

    protected function grid()
    {
        $grid = new Grid(new LuxuryCar());
    ...
    {
        $show = new Show(LuxuryCar::findOrFail($id));
